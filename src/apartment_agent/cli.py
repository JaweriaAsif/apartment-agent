...
from apartment_agent.logging import ConversationLog, append_round
...
async def chat(args: argparse.Namespace) -> int:
    ...
    print("OpenAI Agents SDK apartment search demo")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the OpenAI Agents SDK apartment search demo."
    )
